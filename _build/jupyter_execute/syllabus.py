...
# ## 🔭 Filosofia del corso
# 
# Le lezioni tradizionali di analisi dei dati psicologici si concentrano principalmente sulla teoria della probabilità, il test dell'ipotesi nulla e altri test statistici che sono stati sviluppati molti anni fa. Queste lezioni spesso non utilizzano software o dati reali, ma si basano su dimostrazioni matematiche. Questo approccio può risultare difficile da seguire per gli studenti, poiché i concetti e le equazioni sono spesso complessi e poco intuitivi.
# 
# Invece, in questo corso adotteremo un approccio diverso. Inizieremo con i dati e impareremo come utilizzare la programmazione per trarre inferenze da modelli statistici. Ci concentreremo sull'utilizzo di Python, uno dei linguaggi di programmazione più popolari e richiesti, per analizzare i dati in modo pratico.
# 
# Negli ultimi anni, ci sono state importanti innovazioni nel campo del calcolo statistico e scientifico. I linguaggi di programmazione open source come Python e R hanno superato i pacchetti software aziendali più vecchi e costosi come SAS e SPSS. Oggi, ci sono migliaia di risorse online, come libri, post di blog e tutorial, che offrono eccellenti guide su come analizzare qualsiasi tipo di dati. Questo corso ti darà le competenze fondamentali di Python necessarie per analizzare i dati e rispondere alle domande basate sui dati. Con le basi del linguaggio Python che apprenderai in questo corso, sarai in grado di svolgere le principali analisi dei dati psicologici.
# 
# ## ✔ Prerequisiti
# 
...
# 
# ### Indicazioni ai fini della mitigazione delle infezioni da Sars-Cov-2 nell'Ateneo Fiorentino
# 
# Riporto qui sotto alcune delle recenti indicazioni di Ateneo che ci riguardano.
# 
# - In aula è raccomandato l'uso di dispositivi di protezione delle vie respiratorie. I dispositivi di protezione individuali idonei a garantire un'efficace protezione sono le semimaschere facciali di tipo FFP2 o superiore. 
# - L'immissione di aria fresca in un locale, oltre a migliorare la qualità dell’aria, permette di ridurre la probabilità di trasmissione del virus.
# È raccomandato il frequente ricambio dell'aria mediante apertura delle finestre, soprattutto in locali in cui siano presenti molte persone (per esempio nelle aule tra una lezione e l'altra).
# - Si raccomandano comportamenti volti ad evitare assembramenti ed affollamenti non necessari, soprattutto in locali chiusi.
# - È raccomandata l’igienizzazione frequente delle mani. Allo scopo, presso le sedi universitarie, sono disponibili dispenser di gel idroalcolico. 
# 
# ### Ricevimento
# 
...
# 
# In questo corso, la reciproca considerazione è un aspetto cruciale. Invito tutti ad partecipare attivamente alle discussioni in aula, poiché ognuno può avere opinioni diverse sui vari argomenti affrontati. Proporre un punto di vista diverso è non solo benvenuto ma anche apprezzato. È altrettanto importante mettere in discussione le idee degli altri, comprese le mie. Tuttavia, per garantire che le discussioni siano produttive, mi adopererò nel ruolo di moderatore, assicurando che le idee siano discusse in modo tranquillo e rispettoso, e che gli argomenti vengano presentati in modo chiaro e logico.
# 
